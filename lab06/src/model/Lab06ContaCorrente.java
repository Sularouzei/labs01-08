...
public class Lab06ContaCorrente {
    private int numAge;
    ...
    public Lab06ContaCorrente(int agencia, int conta) {
        setNumAge(agencia);
        setNumConta(conta);
        recuperar();
    }
    ...
    public Lab06ContaCorrente(int agencia, int conta, String nome, double saldo) {
        setNumAge(agencia);
        setNumConta(conta);
        setNome(nome);
        setSaldo(saldo);
