...
public class Lab06ContaCorrenteEspecial extends Lab06ContaCorrente {
    private double limite;

    public Lab06ContaCorrenteEspecial(int agencia, int conta, String nome, double saldo, double limite) {
        super(agencia, conta, nome, saldo);
        this.limite = limite;
        gravaContaEspecial();
    }

    public Lab06ContaCorrenteEspecial(int agencia, int conta) {
        super(agencia, conta);
