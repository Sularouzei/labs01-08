...
public class Lab07ContaCorrente {
    private int numAge;
    ...
    public Lab07ContaCorrente(int agencia, int conta) {
        setNumAge(agencia);
        setNumConta(conta);
        recuperar();
    }
    ...
    public Lab07ContaCorrente(int agencia, int conta, String nome, double saldo) {
        setNumAge(agencia);
        setNumConta(conta);
        setNome(nome);
        setSaldo(saldo);
