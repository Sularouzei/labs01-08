...
public class Lab04ContaCorrente {
    private int numAge;
    ...
    public Lab04ContaCorrente(int agencia, int conta) {
        setNumAge(agencia);
        setNumConta(conta);
        recuperar();
    }
    ...
    public Lab04ContaCorrente(int agencia, int conta, String nome, double saldo) {
        setNumAge(agencia);
        setNumConta(conta);
        setNome(nome);
        setSaldo(saldo);
